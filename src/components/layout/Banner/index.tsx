...
const Banner: React.FC = () => {
  return (
    <div className="flex w-full items-center gap-x-3 border-b-1 border-divider bg-light-gradient dark:bg-dark-gradient px-6 py-2 sm:px-3.5 sm:before:flex-1">
      <p className="text-small text-foreground">
        <Link className="text-inherit" href="#">
          The Winter 2024 Release is here.&nbsp;
        </Link>
      </p>
      {/* <Button
        as={Link}
